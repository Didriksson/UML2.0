...
public class RectangleMarkersFigure {
	...
	rects[0] = new Rectangle2D.Double(this.line.getX1() - recSize / 2,
		this.line.getY1() - recSize / 2, recSize, recSize);
	rects[1] = new Rectangle2D.Double(this.line.getX2() - recSize / 2,
		this.line.getY2() - recSize / 2, recSize, recSize);
